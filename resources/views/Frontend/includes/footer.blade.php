...
<script src="{{ URL::asset('js/bootstrap-hover-dropdown.min.js') }}"></script>
<script src="{{ URL::asset('js/owl.carousel.min.js') }}"></script>
<script src="{{ URL::asset('js/css_browser_selector.min.js') }}"></script>
<script src="{{ URL::asset('js/echo.min.js') }}"></script>
...
<script src="{{ URL::asset('js/jquery.prettyPhoto.min.js') }}"></script>
